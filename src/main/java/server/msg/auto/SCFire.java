...
public class SCFire implements org.apache.thrift.TBase<SCFire, SCFire._Fields>, java.io.Serializable, Cloneable, Comparable<SCFire> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCFire");
  ...
  static {
    schemes.put(StandardScheme.class, new SCFireStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCFireTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCFire.class, metaDataMap);
  }
  ...
  public SCFire deepCopy() {
    return new SCFire(this);
  }
  ...
  public SCFire setPlayerUid(int playerUid) {
    this.playerUid = playerUid;
    setPlayerUidIsSet(true);
    return this;
  }
  ...
  public SCFire setCurrentPosition(server.msg.auto.ThriftVector3 currentPosition) {
    this.currentPosition = currentPosition;
    return this;
  }
  ...
  public SCFire setFireDirection(server.msg.auto.ThriftVector3 fireDirection) {
    this.fireDirection = fireDirection;
    return this;
  }
  ...
  public SCFire setBulletName(String bulletName) {
    this.bulletName = bulletName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCFire)
      return this.equals((SCFire)that);
    return false;
  }

  public boolean equals(SCFire that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SCFire other) {
  ...
  private static class SCFireStandardSchemeFactory implements SchemeFactory {
    public SCFireStandardScheme getScheme() {
      return new SCFireStandardScheme();
    }
  }

  private static class SCFireStandardScheme extends StandardScheme<SCFire> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCFire struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCFire struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SCFireTupleSchemeFactory implements SchemeFactory {
    public SCFireTupleScheme getScheme() {
      return new SCFireTupleScheme();
    }
  }

  private static class SCFireTupleScheme extends TupleScheme<SCFire> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCFire struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCFire struct) throws org.apache.thrift.TException {
