...
public class ThriftVector3 implements org.apache.thrift.TBase<ThriftVector3, ThriftVector3._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftVector3> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ThriftVector3");
  ...
  static {
    schemes.put(StandardScheme.class, new ThriftVector3StandardSchemeFactory());
    schemes.put(TupleScheme.class, new ThriftVector3TupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ThriftVector3.class, metaDataMap);
  }
   ...
   */
  public ThriftVector3(ThriftVector3 other) {
  ...
  public ThriftVector3 deepCopy() {
    return new ThriftVector3(this);
  }
  ...
  public ThriftVector3 setX(int x) {
    this.x = x;
    setXIsSet(true);
    return this;
  }
  ...
  public ThriftVector3 setY(int y) {
    this.y = y;
    setYIsSet(true);
    return this;
  }
  ...
  public ThriftVector3 setZ(int z) {
    this.z = z;
    setZIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ThriftVector3)
      return this.equals((ThriftVector3)that);
    return false;
  }

  public boolean equals(ThriftVector3 that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ThriftVector3 other) {
  ...
  private static class ThriftVector3StandardSchemeFactory implements SchemeFactory {
    public ThriftVector3StandardScheme getScheme() {
      return new ThriftVector3StandardScheme();
    }
  }

  private static class ThriftVector3StandardScheme extends StandardScheme<ThriftVector3> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftVector3 struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftVector3 struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ThriftVector3TupleSchemeFactory implements SchemeFactory {
    public ThriftVector3TupleScheme getScheme() {
      return new ThriftVector3TupleScheme();
    }
  }

  private static class ThriftVector3TupleScheme extends TupleScheme<ThriftVector3> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ThriftVector3 struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ThriftVector3 struct) throws org.apache.thrift.TException {
