...
public class CSHurt implements org.apache.thrift.TBase<CSHurt, CSHurt._Fields>, java.io.Serializable, Cloneable, Comparable<CSHurt> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSHurt");
  ...
  static {
    schemes.put(StandardScheme.class, new CSHurtStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSHurtTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSHurt.class, metaDataMap);
  }
  ...
  public CSHurt setPlayerUid(int playerUid) {
    this.playerUid = playerUid;
    setPlayerUidIsSet(true);
    return this;
  }
  ...
  public CSHurt setHurtValue(int hurtValue) {
    this.hurtValue = hurtValue;
    setHurtValueIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSHurt)
      return this.equals((CSHurt)that);
    return false;
  }

  public boolean equals(CSHurt that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CSHurt other) {
  ...
  private static class CSHurtStandardSchemeFactory implements SchemeFactory {
    public CSHurtStandardScheme getScheme() {
      return new CSHurtStandardScheme();
    }
  }

  private static class CSHurtStandardScheme extends StandardScheme<CSHurt> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSHurt struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSHurt struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CSHurtTupleSchemeFactory implements SchemeFactory {
    public CSHurtTupleScheme getScheme() {
      return new CSHurtTupleScheme();
    }
  }

  private static class CSHurtTupleScheme extends TupleScheme<CSHurt> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSHurt struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSHurt struct) throws org.apache.thrift.TException {
