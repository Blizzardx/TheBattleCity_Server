...
public class CSHandler implements org.apache.thrift.TBase<CSHandler, CSHandler._Fields>, java.io.Serializable, Cloneable, Comparable<CSHandler> {
  ...
  private static final org.apache.thrift.protocol.TField POSITION_FIELD_DESC = new org.apache.thrift.protocol.TField("position", org.apache.thrift.protocol.TType.STRUCT, (short)10);
  private static final org.apache.thrift.protocol.TField DIRECTION_FIELD_DESC = new org.apache.thrift.protocol.TField("direction", org.apache.thrift.protocol.TType.STRUCT, (short)20);
  ...
  public server.msg.auto.ThriftVector3 position; // required
  public server.msg.auto.ThriftVector3 direction; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    POSITION((short)10, "position"),
    DIRECTION((short)20, "direction");
  ...
  public CSHandler(
    server.msg.auto.ThriftVector3 position,
    server.msg.auto.ThriftVector3 direction)
  {
    this();
  ...
  public CSHandler(CSHandler other) {
    if (other.isSetPosition()) {
      this.position = new server.msg.auto.ThriftVector3(other.position);
    }
    if (other.isSetDirection()) {
      this.direction = new server.msg.auto.ThriftVector3(other.direction);
    }
  }
  ...
  public server.msg.auto.ThriftVector3 getPosition() {
    return this.position;
  }

  public CSHandler setPosition(server.msg.auto.ThriftVector3 position) {
    this.position = position;
    return this;
  }
  ...
  public server.msg.auto.ThriftVector3 getDirection() {
    return this.direction;
  }

  public CSHandler setDirection(server.msg.auto.ThriftVector3 direction) {
    this.direction = direction;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case POSITION:
      if (value == null) {
        ...
        setPosition((server.msg.auto.ThriftVector3)value);
      }
      break;
    ...
    case DIRECTION:
      if (value == null) {
        ...
        setDirection((server.msg.auto.ThriftVector3)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 10: // POSITION
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.position = new server.msg.auto.ThriftVector3();
          ...
          case 20: // DIRECTION
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.direction = new server.msg.auto.ThriftVector3();
              struct.direction.read(iprot);
