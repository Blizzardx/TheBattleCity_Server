...
public class SCCreateItem implements org.apache.thrift.TBase<SCCreateItem, SCCreateItem._Fields>, java.io.Serializable, Cloneable, Comparable<SCCreateItem> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCCreateItem");
  ...
  static {
    schemes.put(StandardScheme.class, new SCCreateItemStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCCreateItemTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCCreateItem.class, metaDataMap);
  }
   ...
   */
  public SCCreateItem(SCCreateItem other) {
    __isset_bitfield = other.__isset_bitfield;
    this.positionId = other.positionId;
    this.itemId = other.itemId;
  }

  public SCCreateItem deepCopy() {
    return new SCCreateItem(this);
  }
  ...
  public SCCreateItem setPositionId(int positionId) {
    this.positionId = positionId;
    setPositionIdIsSet(true);
    return this;
  }
  ...
  public SCCreateItem setItemId(int itemId) {
    this.itemId = itemId;
    setItemIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCCreateItem)
      return this.equals((SCCreateItem)that);
    return false;
  }

  public boolean equals(SCCreateItem that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SCCreateItem other) {
  ...
  private static class SCCreateItemStandardSchemeFactory implements SchemeFactory {
    public SCCreateItemStandardScheme getScheme() {
      return new SCCreateItemStandardScheme();
    }
  }

  private static class SCCreateItemStandardScheme extends StandardScheme<SCCreateItem> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCCreateItem struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCCreateItem struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SCCreateItemTupleSchemeFactory implements SchemeFactory {
    public SCCreateItemTupleScheme getScheme() {
      return new SCCreateItemTupleScheme();
    }
  }

  private static class SCCreateItemTupleScheme extends TupleScheme<SCCreateItem> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCCreateItem struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCCreateItem struct) throws org.apache.thrift.TException {
