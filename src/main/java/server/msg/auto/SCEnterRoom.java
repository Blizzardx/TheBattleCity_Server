...
public class SCEnterRoom implements org.apache.thrift.TBase<SCEnterRoom, SCEnterRoom._Fields>, java.io.Serializable, Cloneable, Comparable<SCEnterRoom> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SCEnterRoom");
  ...
  static {
    schemes.put(StandardScheme.class, new SCEnterRoomStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SCEnterRoomTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SCEnterRoom.class, metaDataMap);
  }
   ...
   */
  public SCEnterRoom(SCEnterRoom other) {
  ...
  public SCEnterRoom deepCopy() {
    return new SCEnterRoom(this);
  }
  ...
  public SCEnterRoom setIsSucceed(boolean isSucceed) {
    this.isSucceed = isSucceed;
    setIsSucceedIsSet(true);
    return this;
  }
  ...
  public SCEnterRoom setErrorInfo(String errorInfo) {
    this.errorInfo = errorInfo;
    return this;
  }
  ...
  public SCEnterRoom setPlayerUid(int playerUid) {
    this.playerUid = playerUid;
    setPlayerUidIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SCEnterRoom)
      return this.equals((SCEnterRoom)that);
    return false;
  }

  public boolean equals(SCEnterRoom that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SCEnterRoom other) {
  ...
  private static class SCEnterRoomStandardSchemeFactory implements SchemeFactory {
    public SCEnterRoomStandardScheme getScheme() {
      return new SCEnterRoomStandardScheme();
    }
  }

  private static class SCEnterRoomStandardScheme extends StandardScheme<SCEnterRoom> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SCEnterRoom struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SCEnterRoom struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SCEnterRoomTupleSchemeFactory implements SchemeFactory {
    public SCEnterRoomTupleScheme getScheme() {
      return new SCEnterRoomTupleScheme();
    }
  }

  private static class SCEnterRoomTupleScheme extends TupleScheme<SCEnterRoom> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SCEnterRoom struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SCEnterRoom struct) throws org.apache.thrift.TException {
